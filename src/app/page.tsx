...
export default function Home() {
  ...
  return (
    <main className="min-h-screen relative z-10 px-4 md:px-8 py-12 transition-colors duration-300">
      {/* Hero Section */}
      <section className="relative mt-24 min-h-[80vh] flex flex-col items-center justify-center text-center rounded-[3rem] overflow-hidden border border-white/10 dark:border-white/5 bg-white/20 dark:bg-zinc-950/20 backdrop-blur-2xl shadow-2xl p-8 md:p-16">
        ...
        <div className="max-w-4xl relative z-10">
          <p className="mb-6 text-xs md:text-sm font-bold uppercase tracking-[0.4em] text-green-600 dark:text-green-400">
            Premium Stems for Modern Producers
          </p>
          <h1 className="text-5xl sm:text-6xl lg:text-8xl font-normal leading-none tracking-tight text-zinc-900 dark:text-white heading-font">
          ...
          <p className="text-lg md:text-2xl text-zinc-600 dark:text-zinc-400 max-w-2xl mx-auto mt-8 font-medium leading-relaxed">
          ...
          <div className="mt-12 flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              href="/stems"
              className="inline-flex items-center justify-center rounded-2xl bg-green-600 hover:bg-green-500 dark:bg-green-500 dark:hover:bg-green-400 text-white dark:text-black px-10 py-4 font-bold transition-all duration-300 transform hover:scale-[1.02] shadow-lg hover:shadow-green-500/20"
            >
              Browse Stems
            </Link>
            <Link
              href="/signup"
              className="inline-flex items-center justify-center rounded-2xl border border-zinc-300 dark:border-zinc-800 bg-white/40 dark:bg-black/40 hover:bg-white/60 dark:hover:bg-zinc-900/60 px-10 py-4 font-bold text-zinc-850 dark:text-zinc-200 transition-all duration-300 transform hover:scale-[1.02]"
            >
              Get Started
            </Link>
          </div>
      ...
      <section className="max-w-6xl mx-auto py-24">
        <div className="grid md:grid-cols-3 gap-8">
          <div className="liquid-glass p-10 text-center">
            <h2 className="text-5xl md:text-6xl font-normal text-green-600 dark:text-green-400 heading-font">
      ...
      <section className="max-w-6xl mx-auto py-16">
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-12">
          <div>
            <h2 className="text-4xl md:text-5xl font-normal text-zinc-900 dark:text-white heading-font">
              Featured Stems
            </h2>
          ...
          <Link
            href="/stems"
            className="text-green-600 dark:text-green-400 hover:text-green-500 font-bold flex items-center gap-2 mt-4 md:mt-0 transition duration-200"
          >
        ...
        {loading ? (
          ...
          <div className="liquid-glass p-16 text-center text-zinc-400">
      ...
      <section className="max-w-6xl mx-auto py-24">
        <h2 className="text-4xl md:text-5xl font-normal text-center text-zinc-900 dark:text-white heading-font">
        ...
        <div className="grid md:grid-cols-3 gap-8 mt-16">
          <div className="liquid-glass p-10">
            ...
            <h3 className="text-2xl font-semibold heading-font text-zinc-900 dark:text-white">Studio Quality</h3>
          ...
          <div className="liquid-glass p-10">
            ...
            <h3 className="text-2xl font-semibold heading-font text-zinc-900 dark:text-white">Instant Downloads</h3>
            <p className="text-zinc-600 dark:text-zinc-400 mt-4 leading-relaxed">
          ...
          <div className="liquid-glass p-10">
            ...
            <h3 className="text-2xl font-semibold heading-font text-zinc-900 dark:text-white">Secure Checkout</h3>
            <p className="text-zinc-600 dark:text-zinc-400 mt-4 leading-relaxed">
      ...
      <section className="max-w-4xl mx-auto py-20">
        ...
        <div className="space-y-4 mt-16">
          {faqs.map((faq, idx) => (
            ...
            >
              <div className="p-8 flex items-center justify-between gap-4 select-none">
                <h3 className="font-semibold text-lg md:text-xl text-zinc-900 dark:text-white">
                  {faq.q}
                </h3>
              ...
              >
                <div className="px-8 pb-8 text-zinc-600 dark:text-zinc-400 border-t border-zinc-200/40 dark:border-zinc-800/40 pt-4 leading-relaxed text-sm md:text-base">
                  {faq.a}
                </div>
              </div>
            </div>
